defmodule BeesWeb.Live.Components.Icons do
  @moduledoc false
  ...
  @spec user(%{}) :: Phoenix.LiveView.Rendered.t()
  def user(assigns) do
    ~H"""
    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  @spec home(%{}) :: Phoenix.LiveView.Rendered.t()
  def home(assigns) do
    ~H"""
    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  @spec users(%{}) :: Phoenix.LiveView.Rendered.t()
  ...
  @spec trash(%{}) :: Phoenix.LiveView.Rendered.t()
  ...
  @spec collection(%{}) :: Phoenix.LiveView.Rendered.t()
  ...
  @spec pencil(%{}) :: Phoenix.LiveView.Rendered.t()
  ...
  @spec eye(%{}) :: Phoenix.LiveView.Rendered.t()
  def eye(assigns) do
    svg_wrapper(
      assigns,
      ~H"""
  ...
  defp svg_wrapper(assigns, content) do
    class =
      get_class(
        assigns,
        [size: [sm: "h-4 w-4"], color: [white: "text-white"]],
