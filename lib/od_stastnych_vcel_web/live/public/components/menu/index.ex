defmodule OdStastnychVcelWeb.Public.Live.Components.Menu do
  @moduledoc false

  use OdStastnychVcelWeb, :component

  alias OdStastnychVcelWeb.Public.Live.Components.Menu.Desktop
  alias OdStastnychVcelWeb.Public.Live.Components.Menu.Mobile
