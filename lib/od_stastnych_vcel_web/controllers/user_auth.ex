defmodule OdStastnychVcelWeb.UserAuth do
  @moduledoc false
  ...
  """
  @spec log_in_user(Plug.Conn.t(), User.t(), %{optional(:remember_me) => boolean()}) ::
          Plug.Conn.t()
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      OdStastnychVcelWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
