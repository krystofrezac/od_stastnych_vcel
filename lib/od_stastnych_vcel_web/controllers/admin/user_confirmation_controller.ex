defmodule OdStastnychVcelWeb.Admin.UserConfirmationController do
  ...
  @spec create(Plug.Conn.t(), %{user: %{email: String.t()}}) :: Plug.Conn.t()
  ...
  @spec edit(Plug.Conn.t(), %{token: String.t()}) :: Plug.Conn.t()
  ...
  @spec update(Plug.Conn.t(), %{token: String.t()}) :: Plug.Conn.t()
