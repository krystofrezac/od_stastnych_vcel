defmodule Bees.Accounts.UserToken do
  @moduledoc false
  ...
  schema "users_tokens" do
    ...
    belongs_to :user, Bees.Accounts.User
  ...
  def token_and_context_query(token, context) do
    from Bees.Accounts.UserToken, where: [token: ^token, context: ^context]
  end
  ...
  def user_and_contexts_query(user, :all) do
    from t in Bees.Accounts.UserToken, where: t.user_id == ^user.id
  end

  def user_and_contexts_query(user, [_ | _] = contexts) do
    from t in Bees.Accounts.UserToken,
