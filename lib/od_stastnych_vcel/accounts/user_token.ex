defmodule OdStastnychVcel.Accounts.UserToken do
  @moduledoc false
  ...
  schema "users_tokens" do
    ...
    belongs_to :user, OdStastnychVcel.Accounts.User
  ...
  defp build_hashed_token(user, context, sent_to) do
    ...
    {Base.url_encode64(token, padding: false),
     %OdStastnychVcel.Accounts.UserToken{
       token: hashed_token,
       context: context,
       sent_to: sent_to,
       user_id: user.id
  ...
  def token_and_context_query(token, context) do
    from OdStastnychVcel.Accounts.UserToken, where: [token: ^token, context: ^context]
  end

  @doc """
  Gets all tokens for the given user for the given contexts.
  """
  @spec user_and_contexts_query(User.t(), [:all | String.t()] | :all | String.t()) ::
          Ecto.Query.t()
  def user_and_contexts_query(user, :all) do
    from t in OdStastnychVcel.Accounts.UserToken, where: t.user_id == ^user.id
  end

  def user_and_contexts_query(user, [_ | _] = contexts) do
    from t in OdStastnychVcel.Accounts.UserToken,
